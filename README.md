...
| 🔗 [UpTask](https://uptask-frontend-pi-seven.vercel.app/) | Este es un gestor de Proyecto, donde puedes tener colaboradores, tareas, notas y estados en las tareas | `React` · `Express` · `TypeScript` · `MongoDB` |
