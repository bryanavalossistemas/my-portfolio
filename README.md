...
| 🔗 [Contador de calorías](https://joyful-biscochitos-c2efc9.netlify.app/) | [Contador de calorías]([https://factzil.com/](https://github.com/bryanavalossistemas/contador_calorias)) | Este proyecto es un contador de calorías, la data es almacenada en el local storage del navegador | `React` · `TypeScript` · `Tailwindcss` |
